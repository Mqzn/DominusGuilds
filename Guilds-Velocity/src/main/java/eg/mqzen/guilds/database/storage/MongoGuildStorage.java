...
import eg.mqzen.guilds.database.mongo.MongoDocumentGuildAdapter;
import eg.mqzen.guilds.database.mongo.MongoDocumentObjectAdapter;
...
public class MongoGuildStorage extends BaseGuildStorage {
    ...
    public MongoGuildStorage(DominusGuilds plugin, ConfigurationNode section) throws Exception {
