...
import eg.mqzen.guilds.base.SimpleGuild;
...
import eg.mqzen.guilds.base.SimpleGuildRole;
import eg.mqzen.guilds.base.SimpleGuildTag;
...
public final class MongoDocumentGuildAdapter implements MongoDocumentObjectAdapter<Guild<Player>> {
    ...
    public MongoDocumentGuildAdapter(DominusGuilds plugin) {
        this.plugin = plugin;
    }
